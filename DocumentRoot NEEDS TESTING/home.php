...
if(isset($_POST['submitUsers']))
{
   ...
   $user2 = $_SESSION['user2'];
    ...
    $query = "SELECT leadername FROM follows WHERE followername='$user1' OR followername='$user2' HAVING COUNT(leadername)>= 2";
...
?>
			...
			<form action="" method='post'>			
                ...
                <input type="submit" name="btn3" value="Who's Following Who Need to Work ON" >
