...
$_SESSION["invalidMessage"] = "You can't comment on your own blog!";
...
$queryComments = "SELECT cdate FROM comments WHERE cdate = '$cdate' AND posted_by ='$posted_by'";

$resultComments = mysqli_query($con, $queryComments);



if(mysqli_num_rows($resultComments) > 3)

{ 

echo "error2";

$_SESSION["invalidMessage"] = "You posted enough comments for the day.";
...
$queryOneComments = "SELECT blogid FROM comments WHERE cdate = '$cdate' AND posted_by = '$username' AND blogid = '$blogid'";

$resultOneComments = mysqli_query($con, $queryOneComments);



if(mysqli_num_rows($resultOneComments) == 1)

{

echo "error 3"; 

$_SESSION["invalidMessage"] = "You posted enough comments for one blog.";
...
$queryInsert = "INSERT into comments (sentiment, description, cdate,blogid,posted_by) VALUES ('$sentiment','$description','$cdate', '$blogid', '$posted_by')";
...
echo "<div><td width='80' class='center'>" . $_SESSION["invalidMessage"] . "</td></div>";
